...
def calculator():
    """ Looks at the purchases of the last 2 periods and changes the drinks prices based on said purchases.
            
            returns data_set -> json dictionary with updated prices.
